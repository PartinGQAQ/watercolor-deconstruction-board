...
description: Convert a supplied photo or illustration into an easy-to-paint watercolor teaching board with broad luminous color shapes, lightly cartoonized people, a cumulative line-sketch-to-detail painting sequence, complete standalone scene-element studies, and visual mixing recipes that show how base pigments produce the colors used. Use when the user asks to turn an image into simple or cartoon watercolor, learn a line sketch, base wash, refinement, and detail painting order, make a reference easier to draw or copy, reduce it to broad color blocks, isolate complete scene elements without redesigning them, extract its palette, explain watercolor color mixing, or create a watercolor decomposition, study, reference, or teaching sheet.
---
...
Use a simple low-to-medium-detail watercolor-sketchbook finish by default. Translate the reference into 6–9 dominant shapes or visual layers first, then add only the structural marks required for recognition. Treat the former third-stage look—clear objects, broad washes, a few overlaps, and sparse contours—as the final-detail ceiling. Do not continue toward a fully rendered illustration.
...
- Keep approximately 75–80% broad flat or gently graded washes, 15–20% soft overlaps and structural variations, and no more than 5% fine accents.
...
- Limit the complete painting to roughly 10–16 deliberate structural marks beyond the large color masses. Count a short contour, vein, fold, opening, perspective line, shadow break, or tonal accent as one mark.
...
- For each focal object, allow approximately 2–4 category-defining internal marks after its main washes. Give secondary objects 0–1 mark.
- Represent any repeated system with 2–4 representative marks total, chosen for rhythm and recognition. Never render the entire repetition.
- Omit nonessential features smaller than roughly 2.5–3% of the main painting width. A smaller feature may remain only when it is a high-value identity cue.
...
Limit the complete painting to roughly 10–16 deliberate structural marks beyond the large color masses. A repeated system counts as one visual idea and may use at most 2–4 representative marks; never draw every window, baluster, brick, leaf cluster, cloud puff, cable, fold, seed, crumb, or hair strand. Omit nonessential features smaller than roughly 2.5–3% of the main painting's width. Do not compensate for omitted detail with dense outlines or many tiny watercolor patches.
...
- **Focal architecture:** When a building is the principal subject or one of the selected recognition anchors, keep its complete silhouette, 2–4 main color planes, perspective direction, and at most three architectural anchors. Allow a few broken perspective and construction lines. Represent repeated windows, arches, columns, or railings with 2–4 simplified marks total, not full rows. Delete bricks, balusters, panel seams, trim repetitions, small fixtures, cable webs, vents, and hardware.
...
- **Trees and plants:** Keep one connected crown or plant silhouette, a trunk or stem when needed, and at most three tonal variations. On a focal plant, allow 4–8 complete large leaf shapes or 2–4 broad branch/cluster gestures when they clarify species and growth habit; merge all remaining foliage. Permit at most 1–2 decisive veins or serrated-edge hints across the whole focal plant. Delete leaf-by-leaf backgrounds, small holes, twigs, vein networks, and repeated petals.
...
- **Animals and fish:** Keep the complete silhouette, pose, and 2–4 broad body washes. Allow 2–4 identity marks such as an eye, mouth curve, gill, major fin division, or one patterned region. Do not render every scale, feather, hair, spot, or anatomical crease.
- **Objects, food, and vehicles:** Keep the outer silhouette, 2–4 main color planes, and 2–4 category-defining features on a focal object. Allow only the broad divisions needed to explain grouped contents or construction. A repeated food item should be one uninterrupted mass plus at most one shadow and 0–1 surface hint; never draw every seed, crumb, grain, strand, bubble, reflection, topping, glaze streak, or crust pore. Delete seams, controls, fasteners, granular textures, repeated highlights, and minor attachments.
...
1. **Line sketch:** Draw only the outer silhouettes, main axes or horizon, largest overlap boundaries, and essential perspective. Use about 8–14 pale broken neutral-pencil lines. Do not hatch, shade, texture, close every contour, or draw internal decoration.
2. **Base washes:** Lay the largest and lightest continuous local-color shapes, working light to dark. Preserve highlights as untouched paper. Do not add shadows, texture, small features, or repeated detail.
3. **Refinement:** Add one smaller transparent second wash only where it improves value, warm-cool relationships, overlap, or depth. Soften, lose, or lift selected edges as well as darkening selected areas. Keep most first washes plainly visible; do not render texture.
4. **Minimal details:** Add only 3–6 final accents across the whole thumbnail: a few broken contours, concentrated dark points, or identity cues. Stop as soon as the image reads. The final stage should remain close to stage 3, not become a detailed finished illustration.
...
```text
Treat the reference as source material, not as a checklist. Repaint it as a simple low-to-medium-detail observational watercolor sketch using 6–9 large continuous shapes or visual layers. Aim for the clarity and restraint of a third-stage watercolor study: objects and overlaps are readable, but surface rendering has not begun. Recognition must come first from the outer silhouette, dominant color planes, overall spatial arrangement, and no more than four selected recognition anchors. Keep approximately 75–80% broad washes, 15–20% transparent overlaps, and no more than 5% fine accents. Use one or two washes per shape and generous untouched paper. Keep every major shape continuous rather than constructing it from many small patches. After the large washes, allow only about 10–16 deliberate structural marks in the complete painting, concentrated near the focal subject. Use sparse broken neutral or colored contour lines only to explain overlap, anatomy, perspective, or construction; do not outline every edge. Represent any repeated system with at most 2–4 marks rather than drawing every unit. Omit nonessential features smaller than roughly 2.5–3% of the main painting width. Merge small textures, fixtures, gaps, highlights, local shadows, glaze streaks, crumbs, pores, and repeated details into larger color masses. The large-shape design must remain readable at thumbnail size without the small marks.
...
Across the top, show four small cumulative painting stages of exactly the same composition, numbered only 1, 2, 3, and 4. Preserve identical crop, placement, proportions, silhouettes, pose, and subject geometry in every stage. Treat them as saved states of one painting rather than four reinterpretations. Stage 1 is a true line sketch: about 8–14 pale broken neutral-pencil lines showing only outer silhouettes, main axes or horizon, largest overlaps, and essential perspective; no color, hatching, shading, texture, or closed internal decoration. Stage 2 lays the largest and lightest continuous base washes from light to dark while preserving paper highlights; no shadows or small features. Stage 3 refines the image with one smaller transparent second wash for selected value, warm-cool, overlap, and depth adjustments, while also softening, losing, or lifting selected edges; most first washes remain visible and no surface texture is added. Stage 4 adds only 3–6 final accents across the whole thumbnail, such as a few broken contours, concentrated dark points, or identity cues. Stage 4 must remain very close to stage 3 and stop as soon as the image reads. Every stage must visibly contain the previous stage. Keep the row compact, with irregular open watercolor edges and no rectangular frames.
...
Classify architecture before prompting. If a building is focal, preserve its silhouette, 2–4 main color planes, perspective direction, at most three anchors, a few broken construction lines, and only 2–4 representative repeated marks. If architecture is supporting background, reduce it to one connected silhouette, no more than two broad color planes, and at most three structural hints total: for example one facade edge, one platform rhythm, and one opening mass. Show windows as tonal blocks without frames, balconies as platform silhouettes without railing patterns, and racks or brackets with only 2–3 pale broken strokes across the whole building. Keep supporting architecture lower in contrast, saturation, sharpness, and line density than the focal subject; lose at least half its edges into washes or paper. Delete building lines first whenever they compete with the subject. For a focal tree or plant, preserve a connected silhouette and at most three tonal variations; allow 4–8 complete large leaf shapes or 2–4 broad structural gestures, then merge the rest. For clouds or terrain, preserve the outer contour and 2–4 broad shadow regions. For animals or fish, preserve the complete silhouette, 2–4 body washes, and 2–4 identity marks. For objects, food, or vehicles, preserve the silhouette, 2–4 color planes, and 2–4 category-defining features on the focal object. Keep repeated food units as uninterrupted masses with at most one shadow and 0–1 texture hint each; never render seeds, crumbs, grains, strands, scales, bricks, glaze streaks, crust pores, or wood grain unit by unit.
...
- Four compact cumulative painting stages appear above the main image in the order: line sketch, base washes, refinement, and minimal details.
...
- Stage 1 is a true color-free structural line sketch with about 8–14 pale broken lines and no hatching, shading, or texture.
- Stage 2 contains only the largest light-to-dark base washes; stage 3 adjusts selected value, temperature, overlap, and edges with one smaller transparent pass; stage 4 differs from stage 3 by only 3–6 final accents.
...
- The complete painting contains roughly 10–16 deliberate structural marks beyond its 6–9 large continuous shapes or visual layers.
...
- Repeated structures are suggested with at most 2–4 representative marks rather than rendered unit by unit.
- Nonessential features smaller than roughly 2.5–3% of the main painting width are omitted.
